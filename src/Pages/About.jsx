import { FaShieldAlt, FaUserNurse, FaClock, FaHeart, FaHospitalUser, FaNotesMedical } from "react-icons/fa";
    ...
    <section className="section premium-page-bg">
      <div className="container">
        ...
        <div className="about-layout premium-about-layout">
          <div className="about-main-card card glass-premium-card" data-aos="fade-right">
          ...
          <div className="card premium-side-panel" data-aos="fade-left">
        ...
        <div className="premium-highlight-grid" data-aos="fade-up">
